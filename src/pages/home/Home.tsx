...
function Home() {
  return (
      <Container>
        ...
        <div className="border-t border-dashed border-border py-10 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center gap-2">
            <p className="text-2xl">
            🚚
            </p>
            <p className="text-xs text-foreground">Fast shipping</p>
          </div>
        ...
        <div className="border-t border-dashed border-border py-10">
